...
describe('INT: MultiSignatureExecute', async () => {
  ...
  it('Error when not enough gas', async () => {
    ...
    await expect(messageHandler.handleMessage(signedMessage1, network)).to.be.rejectedWith('Insufficient Gas. Got GasLimitExecution 1 but should greater than 105000');
  });
