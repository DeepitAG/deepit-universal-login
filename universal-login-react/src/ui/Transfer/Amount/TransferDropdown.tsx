...
import {TokenDetails, TokenDetailsWithBalance, getBalanceOf, waitUntil} from '@universal-login/commons';
...
export const TransferDropdown = ({sdk, ensName, currency, setCurrency}: TransferDropdownProps) => {
  ...
  useAsyncEffect(() => sdk.subscribeToBalances(ensName, console.log), []);
  console.log(sdk.tokensDetailsStore.tokensDetails);
